...
namespace Actividad_2_MVVM_David_Oviedo.ViewModel
{
    ...
    public class ReservasViewModel : INotifyPropertyChanged
    {
        ...
        public ReservasViewModel()
        {
            ...
            AbrirSociosCommand = new RelayCommand(AbrirSociosAccion);
            AbrirActividadesCommand = new RelayCommand(AbrirActividadesAccion);
        }
        ...
        {
            var ventana = new View.Socios(); // abre ventana de socios
            ventana.Show();
        }

        private void AbrirActividades()
        {
            var ventana = new View.Actividades(); // abre ventana de actividades
            ventana.Show();
        }
        ...
        private void AbrirSociosAccion(object parameter)
        {
            AbrirSocios();
        }

        private void AbrirActividadesAccion(object parameter)
        {
            AbrirActividades();
        }
